...
usuarioRoutes.post('/', async (req, res) => {
    ...
    try {
      ...
      return res.status(500).json({ erro: 'Erro ao criar o usuário.', detalhes: err.message });
    }
});
...
usuarioRoutes.delete('/:id', async (req, res) => {
    ...
    try {
      ...
      return res.status(500).json({ erro: 'Erro ao excluir o usuário.', detalhes: err.message });
    }
});
...
usuarioRoutes.put('/:id', async (req, res) => {
    ...
    try {
      ...
      return res.status(500).json({ erro: 'Erro ao atualizar o usuário.', detalhes: err.message });
    }
});
